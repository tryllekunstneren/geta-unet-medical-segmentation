#!/bin/bash
#BSUB -J unet_geta_s30          # Job name
#BSUB -q gpuv100                # Queue
#BSUB -n 4                      # CPU cores
#BSUB -R "rusage[mem=8GB]"      # Memory per core
#BSUB -gpu "num=1:mode=exclusive_process"
#BSUB -W 12:00                  # Wall time
#BSUB -o /dtu/blackhole/15/187541/geta_outputs/unet_geta_s30_%J.out
#BSUB -e /dtu/blackhole/15/187541/geta_outputs/unet_geta_s30_%J.err
...
OUT_DIR=/dtu/blackhole/15/187541/geta_outputs/unet_geta_s30

mkdir -p $OUT_DIR

# ---- Run GETA training (30% sparsity) ----
